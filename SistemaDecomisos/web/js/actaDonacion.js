...
function enviarActaDonacion(){
    ...
    var inter = new Interesado(1, fech, "", "", "", "", "");
    var actaDecomiso = new ActaDecomiso(1, policia, test, "" ,fech, " ", inter, " ", " ");
    ...
    var actaDonacion = new ActaDonacion(0, institucion, policia, actaDecomiso); 
